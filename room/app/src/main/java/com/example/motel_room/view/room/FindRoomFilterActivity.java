...
import com.example.motel_room.view.main.FindRoomFragment;
...
public class FindRoomFilterActivity extends AppCompatActivity {
    ...
    private void clickApplyFilter() {
        btnApplyFindRoomFilter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                data.putExtra(FindRoomFragment.SHARE_FINDROOM, findRoomFilterModel);
