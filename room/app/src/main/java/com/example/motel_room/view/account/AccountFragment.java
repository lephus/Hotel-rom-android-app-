package com.example.motel_room.view.account;
...
import com.example.motel_room.view.main.FindRoomMine;
import com.example.motel_room.view.room.FavoriteRoomsActivity;
import com.example.motel_room.view.room.ListBookRoomActivity;
import com.example.motel_room.view.room.RequestBookActivity;
import com.example.motel_room.view.room.RoomManageActivity;
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.btn_contact_support: {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://zalo.me/0328814589"));
