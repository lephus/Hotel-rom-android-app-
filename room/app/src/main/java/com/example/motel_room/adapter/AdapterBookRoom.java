package com.example.motel_room.adapter;
...
public class AdapterBookRoom extends BaseAdapter {
    private final Context context;
    private final int layout;
    private final List<BookRoomModel> bookRoomModelList;
    private final int userRole;
    public AdapterBookRoom(Context context, int layout, List<BookRoomModel> personList, int ok) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        btn_CancelBookRoom.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(data.getID_Status().equals("1")){
                    new AsyncTaskNetwork(context).execute(data.getID());
...
class AsyncTaskNetworkUpdate extends AsyncTask<String, Void, String> {
    ProgressDialog progressDialog;
    Context context;
    String Status;
    public AsyncTaskNetworkUpdate(Context context, String s) {
        this.context = context;
        this.Status = s;
    }
